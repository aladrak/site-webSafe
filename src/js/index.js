...
const cardTexts = [
    { img:'src/img/img1.jpg', title: 'Как происходит фишинг?', text: '1. Злоумышленник создает фишинговый сайт, имитирующий популярный интернет-ресурс.<br>2. Пользователь попадает на этот сайт через ссылку, полученную в социальных сетях или электронной почте.<br>3. После этого он вводит свои личные данные, которые становятся доступными мошенникам.<br>4. В дальнейшем эти данные могут использоваться в незаконных целях.' },
    { img:'src/img/img2.jpg', title: 'Как защитить себя от фишинга?', text: '1. Не общайтесь с незнакомцами, особенно если они просят данные или ссылки.<br>2. Используйте антивирус для защиты системы.<br>3. Не открывайте вложения в электронных письмах.<br>4. Регулярно обновляйте программное обеспечение.<br>5. Никогда не отправляйте пароли по электронной почте и не сохраняйте их на рабочем столе.' },
    { img:'src/img/img3.jpg', title: 'Что делать, если вы получили зловредное письмо?', text: '1. Проверьте адрес электронной почты отправителя.<br>2. Убедитесь, что ссылка начинается с <b>https://</b>, а не <b>http://</b>, перед тем как по ней перейти.<br>3. Не раскрывайте личную информацию и учетные данные третьим лицам.<br>4. Избегайте поспешных действий и паники. Мошенники используют эти эмоции для манипуляции' },
    { img:'src/img/img4.jpg', title: 'Что следует делать, если вы уже перешли по ссылке?', text: '1. Не впадайте в панику. Обновите свои учетные данные на всех веб-сайтах, где вы их использовали.<br>2. Смените пароли или немедленно свяжитесь с вашим банком, в зависимости от ситуации.' }
];
